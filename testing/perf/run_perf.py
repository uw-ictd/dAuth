...
def main():
    ...
    build_config(config, yaml.safe_load(open(args.network_config, 'r')), args.vagrant_dir)
...
def handle_connection(connection_info: dict, vagrant_config: SSHConfig) -> ConnectionConfig:
