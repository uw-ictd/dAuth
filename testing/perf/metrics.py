...
class PerfMetrics:
    ...
    def get_results_json(self) -> str:
        ...
        for name in self.get_names():
            ...
            res["nanoseconds_since_registration"].extend(
                test_res["nanoseconds_since_registration"]
            )
            # res[name] = {
            #     "results": self.get_results(name),
    ...
    def add_result_from_json(self, json_string: str) -> None:
        ...
        if name not in self._results:
            self._results[name] = {
                "nanoseconds_since_auth": [dataset["nanoseconds_since_auth"]],
            ...
            results["nanoseconds_since_auth"].append(dataset["nanoseconds_since_auth"])
