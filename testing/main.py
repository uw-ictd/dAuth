from connections.open5gs_connection import Open5gsConnection
...
def dev_main():
	...
	ueransim = UeransimVM("ueransim", vagrant_dir=vagrant_dir)
	# colte1 = Open5gsVM("colte1", vagrant_dir=vagrant_dir)
